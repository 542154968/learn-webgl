...
export class Mat4 {
  ...
  public multiplyVector3(pos: Mat4) {
    let e = this.elements;
    let p = pos.elements;
    let v = new Vec3();
  ...
  public multiplyVector4(pos: Mat4) {
    let e = this.elements;
    let p = pos.elements;
    let v = new Vec4();
    let result = v.elements;
  ...
  public setInverseOf(other: Mat4) {
    let i, s, d, inv, det;
  ...
  public ortho(
    ...
    return this.concat(
      new Mat4().setOrtho(left, right, bottom, top, near, far)
    );
  }
  ...
  public frustum(
    ...
    return this.concat(
      new Mat4().setFrustum(left, right, bottom, top, near, far)
    );
  }
